...
int main(int argc, char** argv) {
	...
	if ((argc==1) or (argc!=6)){
		cout<<"Uso con webcam:\n";
		cout<<"Filtro 0 salida.avi mascara.avi frames_fondo factor_aprendizaje\n";
		cout<<"Uso con archivo:\n";
		cout<<"Filtro entrada.avi salida.avi mascara.avi frames_fondo factor_aprendizaje\n";
		return 0;
	}
